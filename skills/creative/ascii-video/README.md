...
Built for [Hades Agent](https://github.com/NousResearch/hades-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hades-agent/skills/creative/ascii-video`](https://github.com/NousResearch/hades-agent/tree/main/skills/creative/ascii-video) via PR.
