...
def _build_compact_banner() -> str:
    ...
    if skin_name == "default":
        ...
        agent_name = (
            _skin.get_branding("agent_name", "Hades Agent") if _skin else "Hades Agent"
        )
...
class HadesCLI(CLIAgentSetupMixin, CLICommandsMixin):
    """
    ...
    def show_banner(self):
        ...
        from hades_cli.model_switch import is_nous_hades_non_agentic
    ...
    def save_conversation(self):
        ...
        try:
            ...
            if self.session_id:
                print(
                    f"       Resume the live session with: hades --resume {self.session_id}"
                )
        except Exception as e:
    ...
    def _handle_model_switch(self, cmd_original: str):
        ...
        """
        from hades_cli.model_switch import switch_model, parse_model_flags
        ...
        if canonical in {"quit", "exit"}:
            ...
            try:
                ...
                if not user_entries:
                    ...
                    print(
                        f"  Or drop a plugin directory into {display_hades_home()}/plugins/"
                    )
                    if bundled_count:
                        print(
                            f"  ({bundled_count} bundled plugins available — see: hades plugins list)"
                        )
                else:
                    ...
                    if bundled_count:
                        print(
                            f"  (+{bundled_count} bundled — see: hades plugins list)"
                        )
    ...
    def _print_nous_credits_block(self) -> bool:
        ...
        wall-clock-bounded inside the helper; also honors HADES_DEV_CREDITS_FIXTURE
    ...
    def _voice_speak_response(self, text: str):
        ...
        try:
            ...
            os.makedirs(
                os.path.join(tempfile.gettempdir(), "hades_voice"), exist_ok=True
            )
    ...
    def run(self):
        ...
        try:
            ...
            _welcome_text = _welcome_skin.get_branding(
                "welcome",
                "Welcome to Hades Agent! Type your message or /help for commands.",
            )
        ...
        def _get_clarify_display():
            ...
            lines.append((
                ...
                " "
                + ("─" * max(0, box_width - len("Hades needs your input") - 3))
                + "╮\n",
            ))
            if not use_compact_chrome:
