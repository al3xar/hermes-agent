...
_HADES_CORE_TOOLS = [
    ...
    "terminal", "process",
    # Read the desktop GUI's embedded terminal pane (gated on HADES_DESKTOP
    ...
    # spawned as a kanban worker (HADES_KANBAN_TASK env set) or the current
...
TOOLSETS = {
    ...
    "x_search": {
        "description": (
            ...
            "enable in `hades tools` → X (Twitter) Search."
        ),
        "tools": ["x_search"],
        "includes": []
    },
    ...
    "kanban": {
        "description": (
            ...
            "is spawned by the kanban dispatcher (HADES_KANBAN_TASK env "
    ...
    # ==========================================================================
    # Full Hades toolsets (CLI + messaging platforms)
    #
    ...
    "hades-cron": {
        # Mirrors hades-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `hades tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as hades-cli; gated by `hades tools`",
        "tools": _HADES_CORE_TOOLS,
        "includes": []
    },
    ...
    "hades-webhook": {
        ...
        "tools": _HADES_WEBHOOK_SAFE_TOOLS,
        "includes": []
    },
    ...
    "hades-gateway": {
        ...
        "tools": [],
        "includes": ["hades-telegram", "hades-discord", "hades-whatsapp", "hades-slack", "hades-signal", "hades-bluebubbles", "hades-homeassistant", "hades-email", "hades-sms", "hades-mattermost", "hades-matrix", "hades-dingtalk", "hades-feishu", "hades-wecom", "hades-wecom-callback", "hades-weixin", "hades-qqbot", "hades-webhook", "hades-yuanbao"]
    }
}
...
def resolve_toolset(name: str, visited: Set[str] = None) -> List[str]:
    ...
    if not toolset:
        # Auto-generate a toolset for plugin platforms (hades-<name>).
