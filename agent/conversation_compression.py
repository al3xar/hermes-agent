...
def compress_context(
    ...
    *,
    ...
    # long-lived ``hades_state.SessionDB`` class still bound to the
        ...
        try:
            ...
            if getattr(agent, "_last_compression_lock_error_sid", None) != _lock_sid:
                ...
                logger.warning(
                    ...
                    "process (or `hades update`) to resync.",
    ...
    # compression (not a fresh /new). Plugin engines (e.g. hades-lcm) use
    # boundary_reason="compression" to preserve DAG lineage across the
    # rollover instead of re-initializing fresh per-session state.
    # See hades-lcm#68. Built-in ContextCompressor ignores kwargs.
    try:
