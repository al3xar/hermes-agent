...
upstream prefix cache warm.  See ``hades-agent-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Hades never re-renders parts of this string mid-
    ...
    # Pointer to the hades-agent skill + docs for user questions about Hades itself.
    stable_parts.append(HADES_AGENT_HELP_GUIDANCE)
    ...
    # HADES_KANBAN_TASK env var). Normal chat sessions never see
    ...
    if active_profile == "default":
        stable_parts.append(
            "Active Hades profile: default. Other profiles (if any) live "
        ...
        stable_parts.append(
            f"Active Hades profile: {active_profile}. This session reads "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Hades never rebuilds or reinjects parts of it
