...
- :func:`list_bundles` — return rich info for display (``hades bundles``)
...
def _bundles_dir() -> Path:
    ...
    Honors ``HADES_BUNDLES_DIR`` for tests; falls back to
...
# ---------------------------------------------------------------------------
# File-level CRUD helpers — used by `hades bundles` CLI subcommand.
# ---------------------------------------------------------------------------
