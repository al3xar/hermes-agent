...
multiple consecutive (assistant, tool) pairs, which is the same shape Hades
...
class CodexEventProjector:
    ...
    items but Hades stashes it on the next assistant message)."""
    ...
    def project(self, notification: dict) -> ProjectionResult:
        ...
        # don't enter the messages list — same way Hades already only writes
