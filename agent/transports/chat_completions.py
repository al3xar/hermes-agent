...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate Hades/OpenRouter-style reasoning config to Gemini thinkingConfig."""
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - Hades-internal scaffolding markers — any top-level message key
        ...
        for msg in sanitized:
            ...
            # Drop all Hades-internal scaffolding markers (``_``-prefixed).
