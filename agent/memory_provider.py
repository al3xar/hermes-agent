...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - hades_home (str): The active HADES_HOME directory path. Use this
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "hades").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'hades memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], hades_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'hades memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``hades_home`` is the active HADES_HOME directory path.
