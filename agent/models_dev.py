...
# ---------------------------------------------------------------------------
# Provider ID mapping: Hades ↔ models.dev
# ---------------------------------------------------------------------------

# Hades provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → Hades (built lazily)
...
def fetch_models_dev(force_refresh: bool = False) -> Dict[str, Any]:
    ...
    When ``force_refresh=True`` (used by ``hades config refresh``, the
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Hades provider ID to its models dict from models.dev.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a Hades provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve Hades ID → models.dev ID
...
def get_model_info(
    ...
    Accepts Hades or models.dev provider ID.  Tries exact match then
