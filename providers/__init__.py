...
1. Bundled plugins: ``plugins/model-providers/<name>/`` (shipped with hades-agent)
...
def _import_plugin_dir(plugin_dir: Path, source: str) -> None:
    ...
    if source == "bundled":
        ...
        module_name = f"_hades_user_provider_{safe_name}"
...
def _discover_providers() -> None:
    ...
    # 1. Bundled plugins — shipped with hades-agent.
