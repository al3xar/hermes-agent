...
(``HADES_SESSION_PLATFORM``, ``HADES_SESSION_CHAT_ID``, etc.) with
...
_SESSION_PLATFORM: ContextVar = ContextVar("HADES_SESSION_PLATFORM", default=_UNSET)
_SESSION_CHAT_ID: ContextVar = ContextVar("HADES_SESSION_CHAT_ID", default=_UNSET)
_SESSION_CHAT_NAME: ContextVar = ContextVar("HADES_SESSION_CHAT_NAME", default=_UNSET)
_SESSION_THREAD_ID: ContextVar = ContextVar("HADES_SESSION_THREAD_ID", default=_UNSET)
_SESSION_USER_ID: ContextVar = ContextVar("HADES_SESSION_USER_ID", default=_UNSET)
_SESSION_USER_NAME: ContextVar = ContextVar("HADES_SESSION_USER_NAME", default=_UNSET)
_SESSION_KEY: ContextVar = ContextVar("HADES_SESSION_KEY", default=_UNSET)
...
_SESSION_MESSAGE_ID: ContextVar = ContextVar("HADES_SESSION_MESSAGE_ID", default=_UNSET)

# Cron auto-delivery vars — set per-job in run_job() so concurrent jobs
# don't clobber each other's delivery targets.
_CRON_AUTO_DELIVER_PLATFORM: ContextVar = ContextVar("HADES_CRON_AUTO_DELIVER_PLATFORM", default=_UNSET)
_CRON_AUTO_DELIVER_CHAT_ID: ContextVar = ContextVar("HADES_CRON_AUTO_DELIVER_CHAT_ID", default=_UNSET)
_CRON_AUTO_DELIVER_THREAD_ID: ContextVar = ContextVar("HADES_CRON_AUTO_DELIVER_THREAD_ID", default=_UNSET)

_VAR_MAP = {
    "HADES_SESSION_PLATFORM": _SESSION_PLATFORM,
    "HADES_SESSION_CHAT_ID": _SESSION_CHAT_ID,
    "HADES_SESSION_CHAT_NAME": _SESSION_CHAT_NAME,
    "HADES_SESSION_THREAD_ID": _SESSION_THREAD_ID,
    "HADES_SESSION_USER_ID": _SESSION_USER_ID,
    "HADES_SESSION_USER_NAME": _SESSION_USER_NAME,
    "HADES_SESSION_KEY": _SESSION_KEY,
    "HADES_SESSION_ID": _SESSION_ID,
    "HADES_SESSION_MESSAGE_ID": _SESSION_MESSAGE_ID,
    "HADES_CRON_AUTO_DELIVER_PLATFORM": _CRON_AUTO_DELIVER_PLATFORM,
    "HADES_CRON_AUTO_DELIVER_CHAT_ID": _CRON_AUTO_DELIVER_CHAT_ID,
    "HADES_CRON_AUTO_DELIVER_THREAD_ID": _CRON_AUTO_DELIVER_THREAD_ID,
}
...
def get_session_env(name: str, default: str = "") -> str:
    """Read a session context variable by its legacy ``HADES_SESSION_*`` name.
