...
try:
    ...
    _HADES_VERSION = "0.0.0"

_APP_VERSION = _HADES_VERSION
_BOT_VERSION = _HADES_VERSION
_YUANBAO_INSTANCE_ID = str(HADES_INSTANCE_ID)  # single source: yuanbao_proto.HADES_INSTANCE_ID
