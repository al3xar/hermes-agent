...
Report privately via [GitHub Security Advisories](https://github.com/NousResearch/hades-agent/security/advisories/new)
...
- **Documented break-glass settings.** Operator-selected trade-offs
  ...
  hades-home security, and similar. Reports against those
