...
_DOCS_BASE = "https://hades-agent.nousresearch.com/docs"
...
def _setup_slack():
    ...
    print()
    print_info("   Full guide: https://hades-agent.nousresearch.com/docs/user-guide/messaging/slack/")
    print()
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://hades-agent.nousresearch.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://hades-agent.nousresearch.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()
...
def _load_openclaw_migration_module():
    ...
    spec = importlib.util.spec_from_file_location(
        "openclaw_to_hades", _OPENCLAW_SCRIPT
    )
