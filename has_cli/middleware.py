"""Hades middleware contract helpers.
...
OBSERVER_SCHEMA_VERSION = "hades.observer.v1"
MIDDLEWARE_SCHEMA_VERSION = "hades.middleware.v1"
...
def apply_llm_request_middleware(
    ...
    **context: Any,
    ...
    provider kwargs before Hades sends them.
    """
