...
def _find_bundled_tui(hades_cli_dir: Path | None = None) -> Path | None:
    """Find a pre-built TUI entry.js bundled in the wheel."""
    if hades_cli_dir is None:
        hades_cli_dir = Path(__file__).parent
    bundled = hades_cli_dir / "tui_dist" / "entry.js"
