...
Used by ``hades kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``hades_cli/goals.py`` — same aux
...
HADES_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("HADES_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
    ...
    *,
    ...
    try:
        resp = client.chat.completions.create(
            ...
            temperature=0.3,
            max_tokens=HADES_KANBAN_SPECIFY_MAX_TOKENS,
