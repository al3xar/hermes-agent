...
7. [在 Hades 中使用语音模式](/guides/use-voice-mode-with-hades)
...
2. [构建 Hades 插件](/guides/build-a-hades-plugin)
...
:::tip
对于大多数自定义工具的创建，建议从插件开始。[添加工具](/developer-guide/adding-tools)页面面向 Hades 核心内置开发，而非常规用户/自定义工具路径。
:::
...
| **代码执行** | 运行以编程方式调用 Hades 工具的 Python 脚本 | [代码执行](/user-guide/features/code-execution) |
