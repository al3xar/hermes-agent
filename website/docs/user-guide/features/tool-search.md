...
**Tool Search** is Hades' opt-in progressive-disclosure layer for that
...
When the model invokes `tool_call`, Hades **unwraps the bridge** and
...
- **No JS sandbox.** Hades uses the simpler "structured tools" mode
