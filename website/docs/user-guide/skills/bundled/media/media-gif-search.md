...
Set your Tenor API key in your environment (add to `~/.hades/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/hades-agent/blob/main/skills/media/gif-search/url)`
