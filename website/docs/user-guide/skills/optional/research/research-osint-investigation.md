...
| | |
|---|---|
| Source | Optional — install with `hades skills install official/research/osint-investigation` |
...
# $HADES_OSINT_CACHE/icij/ (default: ~/.cache/hades-osint/icij/).
...
# Set HADES_OSINT_UA=your-app/1.0 (your@email) to identify yourself
