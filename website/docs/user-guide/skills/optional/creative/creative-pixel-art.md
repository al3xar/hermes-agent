...
| | |
|---|---|
| Source | Optional — install with `hades skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.hades/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.hades/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Hades installs package this)
