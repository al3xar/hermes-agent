...
| | |
|---|---|
| Source | Optional — install with `hades skills install official/health/neuroskill-bci` |
...
Connect Hades to a running [NeuroSkill](https://neuroskill.com/) instance to read
