...
| | |
|---|---|
| Source | Optional — install with `hades skills install official/web-development/page-agent` |
...
- User wants **Hades itself to drive a browser** → use Hades' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
