...
If a model is genuinely missing, [open an issue](https://github.com/NousResearch/hades-agent/issues) — we surface the Portal's catalog to Hades and gaps usually mean a routing config we can update.
