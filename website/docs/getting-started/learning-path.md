...
First-time users almost always want `hades setup --portal` — one OAuth covers a model plus the four Tool Gateway tools (search/image/TTS/browser). See [Nous Portal](/integrations/nous-portal).
:::
...
7. [Use Voice Mode with Hades](/guides/use-voice-mode-with-hades)
...
2. [Build a Hades Plugin](/guides/build-a-hades-plugin)
