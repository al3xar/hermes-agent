...
def _install_tirith(*, log_failures: bool = True) -> tuple[str | None, str]:
    ...
    try:
        ...
        dest = os.path.join(_hades_bin_dir(), "tirith")
        try:
...
def _resolve_tirith_path(configured_path: str) -> str:
    ...
    hades_bin = os.path.join(_hades_bin_dir(), "tirith")
    if os.path.isfile(hades_bin) and os.access(hades_bin, os.X_OK):
        _resolved_path = hades_bin
        _install_failure_reason = ""
        _clear_install_failed()
        return hades_bin
