...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hades/\.env|\~/\.hades/\.env',
     "hades_env_access", "critical", "exfiltration",
     "directly references Hades secrets file"),
    ...
    (r'\.hades/config\.yaml|\.hades/SOUL\.md',
     "hades_config_mod", "critical", "persistence",
     "references Hades configuration files directly"),
...
# scan. `.skillignore` is the Hades-native name; `.clawhubignore` is honored
