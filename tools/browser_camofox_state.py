...
persistent browser profiles.  When managed persistence is enabled, Hades
...
def get_camofox_identity(task_id: Optional[str] = None) -> Dict[str, str]:
    ...
    The user identity is profile-scoped (same Hades profile = same userId).
