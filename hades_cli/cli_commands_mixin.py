...
class CLICommandsMixin:
    ...
    def _handle_image_command(self, cmd_original: str):
        ...
        if _remainder:
            ...
            _cprint(f"  {_DIM}Tip: type your next message, or run hades chat -q --image {_termux_example_image_path(image_path.name)} \"What do you see?\"{_RST}")
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if not session_meta:
            ...
            _cprint("  Use /history or `hades sessions list` to see available sessions.")
            return
