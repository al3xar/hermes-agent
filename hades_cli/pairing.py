...
Usage:
    hades pairing list              # Show all pending + approved users
    hades pairing approve <platform> <code>  # Approve a pairing code
    hades pairing revoke <platform> <user_id> # Revoke user access
    hades pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle hades pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: hades pairing {list|approve|revoke|clear-pending}")
        print("Run 'hades pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'hades pairing list' to see pending codes.\n")
