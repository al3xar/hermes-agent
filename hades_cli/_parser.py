...
def _inherited_flag(parser, *args, **kwargs):
    """Register a flag that ``has_cli.relaunch`` should carry over when
...
def build_top_level_parser():
    ...
    _inherited_flag(
        ...
        help=(
            ...
            "Applies to -z/--oneshot and --tui. Also settable via HADES_INFERENCE_MODEL env var."
        ),
    )
    _inherited_flag(
        parser,
    ...
    _inherited_flag(
        ...
        help=(
            ...
            "without a TTY prompt.  Equivalent to HADES_ACCEPT_HOOKS=1 or "
    ...
    _inherited_flag(
        ...
        help=(
            "Auto-approve any unseen shell hooks declared in config.yaml "
            "without a TTY prompt (see also HADES_ACCEPT_HOOKS env var and "
