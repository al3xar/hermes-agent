...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    layout_table.add_column("left", justify="center", no_wrap=True)
    layout_table.add_column("right", justify="left", no_wrap=True, overflow="ellipsis")
    ...
    if runtime:
        left_lines.append(f"[dim {dim}]Runtime: {runtime}[/]")
