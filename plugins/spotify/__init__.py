...
``_check_spotify_available()`` — when the user has not run ``hades auth
spotify``, the tools remain registered (so they appear in ``hades
...
The Spotify auth flow (``hades auth spotify``), CLI plumbing, and docs
