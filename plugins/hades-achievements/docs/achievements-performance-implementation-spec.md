# Hades Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.hades/plugins/hades-achievements/state.json` (existing unlock state)
  - `~/.hades/plugins/hades-achievements/scan_snapshot.json` (new)
  - `~/.hades/plugins/hades-achievements/scan_checkpoint.json` (new)
