# Hades Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.hades/plugins/hades-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.hades/plugins/hades-achievements/scan_checkpoint.json`.
