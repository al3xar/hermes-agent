(function () {
  "use strict";
  // hades-achievements dashboard plugin
  // Originally authored by @PCinkusz — https://github.com/PCinkusz/hades-achievements (MIT).
  // Bundled into hades-agent. Upstream repo remains the staging ground for new
  ...
  if (!SDK || !window.__HADES_PLUGINS__) return;
  ...
  const useI18n =
    SDK.useI18n ||
    function () {
      return { t: { achievements: null }, locale: "en" };
    };
  ...
  const LUCIDE = {
    ...
    wand: '<path d="m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.72 0L2.36 18.64a1.21 1.21 0 0 0 0 1.72l1.28 1.28a1.2 1.2 0 0 0 1.72 0L21.64 5.36a1.2 1.2 0 0 0 0-1.72" />\n  <path d="m14 7 3 3" />\n  <path d="M5 6v4" />\n  <path d="M19 14v4" />\n  <path d="M10 2v2" />\n  <path d="M7 8H3" />\n  <path d="M21 16h-4" />\n  <path d="M11 3H9" />',
    folder:
  ...
  function api(path, options) {
    ...
    // BOTH dashboard modes: loopback (X-Hades-Session-Token header) and
    // gated OAuth (hades_session_at cookie via credentials:'include').
    // Hand-rolling fetch + reading window.__HADES_SESSION_TOKEN__ directly
    ...
    const url = "/api/plugins/hades-achievements" + path;
  ...
  async function buildShareImage(achievement) {
    ...
    if (progressValue && threshold) {
      statLine =
        progressValue.toLocaleString() + " / " + threshold.toLocaleString();
    ...
    ctx.fillText("HADES AGENT  ·  hades-agent.nousresearch.com", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function download() {
      ...
      a.href = url;
      a.download = "hades-achievement-" + (achievement.id || "badge") + ".png";
    ...
    function tweetText() {
      ...
      const tmpl = tx(
        t,
        "share.tweet_text",
        'Just unlocked {tier_part}"{name}" in Hades Agent ☤',
        {
          tier_part: tierPart,
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "ha-share-head" },
          React.createElement(
            "strong",
            null,
            tx(t, "share.header", "Share: {name}", { name: achievement.name }),
          ),
          React.createElement(
            "button",
            {
              className: "ha-share-close",
              onClick: onClose,
              "aria-label": tx(t, "share.close", "Close"),
            },
            "×",
          ),
        ),
        React.createElement(
          "div",
          { className: "ha-share-preview" },
          status === "rendering" &&
            React.createElement(
              "div",
              { className: "ha-share-placeholder" },
              tx(t, "share.rendering", "Rendering…"),
            ),
          previewUrl &&
            React.createElement("img", {
              src: previewUrl,
              alt: tx(t, "share.card_alt", "{name} share card", {
                name: achievement.name,
              }),
            }),
        ),
        status === "error" &&
          React.createElement(
            "div",
            { className: "ha-share-error" },
            errorMsg || tx(t, "share.error_generic", "Something went wrong."),
          ),
        React.createElement(
          "div",
          { className: "ha-share-actions" },
          React.createElement(
            "button",
            {
          ...
          React.createElement(
            "button",
            {
              ...
              title: tx(
                t,
                "share.copy_title",
                "Copy the image to paste into your post",
              ),
            },
            status === "copied"
              ? tx(t, "share.copied", "Copied ✓")
              : tx(t, "share.copy_button", "Copy image"),
          ),
          React.createElement(
            "button",
            {
  ...
  function StatCard(props) {
    return React.createElement(
      ...
      React.createElement(
        ...
        props.hint &&
          React.createElement("div", { className: "ha-stat-hint" }, props.hint),
      ),
    );
  }
  ...
  function TierLegend() {
    return React.createElement(
      "div",
      { className: "ha-tier-legend" },
      ["Copper", "Silver", "Gold", "Diamond", "Olympian"].map(
        function (tier, index, arr) {
          return React.createElement(
            React.Fragment,
            { key: tier },
            React.createElement(
              "span",
              { className: "ha-tier-step ha-tier-" + tier.toLowerCase() },
              React.createElement("i", null),
              tier,
            ),
            index < arr.length - 1 &&
              React.createElement("span", { className: "ha-tier-arrow" }, "→"),
          );
        },
      ),
    );
  ...
  function LoadingSkeletonCard(props) {
    return React.createElement(
      C.Card,
      { className: "ha-card ha-skeleton-card ha-tier-pending" },
      React.createElement(
        C.CardContent,
        { className: "ha-card-content" },
        React.createElement(
          "div",
          { className: "ha-card-head" },
          React.createElement("div", {
            className: "ha-skeleton ha-skeleton-icon",
          }),
          React.createElement(
            "div",
            { className: "ha-skeleton-stack" },
            React.createElement("div", {
              className: "ha-skeleton ha-skeleton-title",
            }),
            React.createElement("div", {
              className: "ha-skeleton ha-skeleton-meta",
            }),
          ),
          React.createElement(
            "div",
            { className: "ha-badges" },
            React.createElement("div", {
              className: "ha-skeleton ha-skeleton-badge",
            }),
            React.createElement("div", {
              className:
                "ha-skeleton ha-skeleton-badge ha-skeleton-badge-short",
            }),
          ),
        ),
        React.createElement("div", {
          className: "ha-skeleton ha-skeleton-line",
        }),
        React.createElement("div", {
          className: "ha-skeleton ha-skeleton-line ha-skeleton-line-short",
        }),
        React.createElement("div", {
          className: "ha-skeleton ha-skeleton-criteria",
        }),
        React.createElement(
          "div",
          { className: "ha-evidence-slot" },
          React.createElement("div", {
            className: "ha-skeleton ha-skeleton-evidence",
          }),
        ),
        React.createElement(
          "div",
          { className: "ha-progress-row" },
          React.createElement("div", {
            className: "ha-skeleton ha-skeleton-progress",
          }),
          React.createElement("div", {
            className: "ha-skeleton ha-skeleton-progress-text",
          }),
        ),
      ),
    );
  ...
  function LoadingPage() {
    ...
    return React.createElement(
      "div",
      { className: "ha-page ha-page-loading" },
      React.createElement(
        "section",
        { className: "ha-hero ha-loading-hero" },
        React.createElement(
          "div",
          null,
          React.createElement(
            "div",
            { className: "ha-kicker" },
            tx(t, "hero.kicker", "Agentic Gamerscore"),
          ),
          React.createElement(
            "h1",
            null,
            tx(t, "hero.title", "Hades Achievements"),
          ),
          React.createElement(
            "p",
            null,
        ...
        React.createElement(
          "div",
          {
            className: "ha-scan-status",
            role: "status",
            "aria-live": "polite",
          },
          React.createElement("span", {
            className: "ha-scan-pulse",
            "aria-hidden": "true",
          }),
          React.createElement(
            "div",
      ...
      React.createElement(
        ...
        [
          ...
          return React.createElement(
            C.Card,
            { key: entry.key, className: "ha-stat ha-skeleton-stat" },
            React.createElement(
              C.CardContent,
              { className: "ha-stat-content" },
              React.createElement("div", { className: "ha-stat-label" }, label),
              React.createElement("div", {
                className: "ha-skeleton ha-skeleton-stat-value",
              }),
              React.createElement("div", {
                className: "ha-skeleton ha-skeleton-stat-hint",
              }),
            ),
          );
        }),
      ...
      React.createElement(
        "section",
        { className: "ha-guide ha-loading-guide" },
        React.createElement(
          "div",
          null,
          React.createElement(
            "strong",
            null,
            tx(t, "guide.scan_status_header", "Scan status"),
          ),
          React.createElement(
            "p",
            null,
        ...
        React.createElement(
          ...
          React.createElement(
            "strong",
            null,
            tx(t, "guide.what_scanned_header", "What is scanned"),
          ),
          React.createElement(
            "p",
            null,
  ...
  function AchievementCard({ achievement }) {
    ...
    const stateLabel =
      state === "unlocked"
        ...
        : state === "secret"
          ? tx(t, "state.secret", "Secret")
          : tx(t, "state.discovered", "Discovered");
    ...
    return React.createElement(
      C.Card,
      {
        className: cn(
          "ha-card",
          "ha-state-" + state,
          tierClass(achievement.tier || achievement.next_tier),
        ),
      },
      React.createElement(
        C.CardContent,
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: "ha-icon" },
            React.createElement(AchievementIcon, {
              icon: achievement.icon || "secret",
            }),
          ),
          React.createElement(
            "div",
            { className: "ha-card-title-wrap" },
            React.createElement(
              "div",
              { className: "ha-card-title" },
              achievement.name,
            ),
            React.createElement(
              "div",
              { className: "ha-card-category" },
          ...
          React.createElement(
            ...
            React.createElement(
              "span",
              { className: "ha-state-badge" },
              stateLabel,
            ),
            React.createElement(
              "span",
              { className: "ha-tier-badge" },
              tierLabel,
            ),
            state === "unlocked" &&
              React.createElement(
                "button",
                {
                  ...
                  "aria-label": tx(t, "card.share_label", "Share {name}", {
                    name: achievement.name,
                  }),
                },
        ...
        React.createElement(
          ...
          achievement.evidence
            ? React.createElement(
                "div",
                { className: "ha-evidence" },
                React.createElement(
                  "span",
                  { className: "ha-evidence-label" },
                  tx(t, "card.evidence_label", "Evidence"),
                ),
                React.createElement(
                  "span",
                  { className: "ha-evidence-title" },
                  achievement.evidence.title ||
                    achievement.evidence.session_id ||
                    tx(t, "card.evidence_session_fallback", "session"),
                ),
              )
            : React.createElement(
                "div",
                {
                  className: "ha-evidence ha-evidence-empty",
                  "aria-hidden": "true",
                },
                tx(t, "card.no_evidence", "No evidence yet"),
              ),
        ),
        React.createElement(
          "div",
          ...
          React.createElement(
            "div",
            { className: "ha-progress-track" },
            React.createElement("div", {
              className: "ha-progress-fill",
              style: {
                width:
                  Math.max(state === "secret" ? 0 : 3, Math.min(100, pct)) +
                  "%",
              },
            }),
          ),
  ...
  function AchievementsPage() {
    ...
    const unlocked = achievements.filter(function (a) {
      return a.state === "unlocked";
    });
    const discovered = achievements.filter(function (a) {
      return a.state === "discovered";
    });
    const secret = achievements.filter(function (a) {
      return a.state === "secret";
    });
    const latest = unlocked
      ...
      .slice(0, 5);
    const highest =
      ["Olympian", "Diamond", "Gold", "Silver", "Copper"].find(function (tier) {
        return unlocked.some(function (a) {
          return a.tier === tier;
        });
    ...
    if (scanInFlight) {
      ...
      const scanned = Number(
        meta.sessions_scanned_so_far || meta.sessions_total || 0,
      );
      const total = Number(meta.sessions_expected_total || 0);
      const pct =
        total > 0
          ? Math.max(0, Math.min(100, Math.floor((scanned / total) * 100)))
          : 0;
      const headline =
        scanMode === "pending"
      ...
      scanBanner = React.createElement(
        "section",
        { className: "ha-scan-banner", role: "status", "aria-live": "polite" },
        React.createElement(
          "div",
          { className: "ha-scan-banner-head" },
          React.createElement("span", {
            className: "ha-scan-pulse",
            "aria-hidden": "true",
          }),
        ...
        total > 0 &&
          React.createElement(
            "div",
            {
              className: "ha-scan-progress-track",
              role: "progressbar",
              "aria-valuemin": 0,
              "aria-valuemax": 100,
              "aria-valuenow": pct,
            ...
            React.createElement("div", {
              className: "ha-scan-progress-fill",
              style: { width: pct + "%" },
            }),
          ),
      );
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          C.Button,
          { onClick: load, className: "ha-refresh" },
          tx(t, "actions.rescan", "Rescan"),
        ),
      ),
      scanBanner,
      error &&
        React.createElement(
          C.Card,
          { className: "ha-error" },
          React.createElement(C.CardContent, null, String(error)),
        ),
      React.createElement(
        "div",
        { className: "ha-stats" },
        React.createElement(StatCard, {
          label: tx(t, "stats.unlocked", "Unlocked"),
          value:
            (data ? data.unlocked_count : 0) +
            " / " +
            (data ? data.total_count : 0),
          hint: tx(t, "stats.unlocked_hint", "earned badges"),
        }),
        React.createElement(StatCard, {
          label: tx(t, "stats.discovered", "Discovered"),
          value: discovered.length,
          hint: tx(t, "stats.discovered_hint", "known, not earned yet"),
        }),
        React.createElement(StatCard, {
          label: tx(t, "stats.secrets", "Secrets"),
          value: secret.length,
          hint: tx(t, "stats.secrets_hint", "hidden until first signal"),
        }),
        React.createElement(StatCard, {
          label: tx(t, "stats.highest_tier", "Highest tier"),
          value: highest,
          hint: tx(
            t,
            "stats.highest_tier_hint",
        ...
        React.createElement(StatCard, {
          ...
          hint: latest[0]
            ? latest[0].category
            : tx(t, "stats.latest_hint_empty", "run Hades more"),
        }),
      ),
      React.createElement(
        "section",
        ...
        React.createElement(
          ...
          React.createElement(
            "strong",
            null,
            tx(t, "guide.secret_header", "Secret achievements"),
          ),
          React.createElement(
            "p",
            null,
      ...
      React.createElement(
        ...
        React.createElement(
          "div",
          { className: "ha-pills" },
          ["all", "unlocked", "discovered", "secret"].map(function (v) {
            return React.createElement(
              "button",
              {
                key: v,
      ...
      latest.length > 0 &&
        React.createElement(
          ...
          React.createElement(
            "h2",
            null,
            tx(t, "latest.header", "Recent unlocks"),
          ),
          React.createElement(
            "div",
            { className: "ha-latest-row" },
            latest.map(function (a) {
              return React.createElement(
                "div",
                { key: a.id, className: cn("ha-chip", tierClass(a.tier)) },
                React.createElement(
                  "span",
                  { className: "ha-chip-icon" },
                  React.createElement(AchievementIcon, {
                    icon: a.icon || "secret",
                  }),
                ),
      ...
      visibility === "secret" &&
        ...
        React.createElement(
          C.Card,
          { className: "ha-secret-empty" },
          React.createElement(
            C.CardContent,
            { className: "ha-secret-empty-content" },
            React.createElement(
              "strong",
              null,
              tx(
                t,
                "empty.no_secrets_header",
                "No hidden secrets left in this scan.",
              ),
            ),
            React.createElement(
              "p",
  ...
  window.__HADES_PLUGINS__.register("hades-achievements", AchievementsPage);
})();
