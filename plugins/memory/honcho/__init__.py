...
class HonchoMemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, hades_home):
        ...
        config_path = Path(hades_home) / "honcho.json"
        existing = {}
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        try:
            ...
            try:
                ...
                # behave as they did before. New setups via `hades honcho setup`
    ...
    def _start_session_init_background(self, *, wait_timeout: float = 0.0) -> None:
        ...
        with self._init_lock:
            ...
            init_session_id = self._lazy_init_session_id or "hades-default"
    ...
    def _do_session_init(self, cfg, session_id: str, **kwargs) -> None:
        ...
        # Skip under per-session strategy: every Hades run creates a fresh
    ...
    def _ensure_session(self) -> bool:
        ...
        try:
            self._do_session_init(
                self._config,
                self._lazy_init_session_id or "hades-default",
