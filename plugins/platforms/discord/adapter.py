...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = float(os.getenv("HADES_DISCORD_TEXT_BATCH_DELAY_SECONDS", "0.6"))
        self._text_batch_split_delay_seconds = float(os.getenv("HADES_DISCORD_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0"))
    ...
    def _canonicalize_app_command_payload(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Reduce command payloads to the semantic fields Hades manages."""
    ...
    def _register_slash_commands(self) -> None:
        ...
        # hades_cli/commands.py automatically appear as Discord slash
...
def _define_discord_view_classes() -> None:
    ...
    class UpdatePromptView(discord.ui.View):
        """Interactive Yes/No buttons for ``hades update`` prompts.
...
# is not in this process (e.g. ``hades cron`` running standalone) and no live
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # hades_cli/setup.py::_setup_discord function.  Same shape as Teams.
