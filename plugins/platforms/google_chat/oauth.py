...
try:
    ...
    # Fallback for environments where hades_constants isn't importable
...
def _legacy_token_path() -> Path:
    return _hades_home() / "google_chat_user_token.json"


def _user_tokens_dir() -> Path:
    return _hades_home() / "google_chat_user_tokens"


def _legacy_pending_path() -> Path:
    return _hades_home() / "google_chat_user_oauth_pending.json"


def _user_pending_dir() -> Path:
    return _hades_home() / "google_chat_user_oauth_pending"
...
def _client_secret_path() -> Path:
    return _hades_home() / "google_chat_user_client_secret.json"
