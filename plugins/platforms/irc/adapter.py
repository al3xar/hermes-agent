...
class IRCAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config, **kwargs):
        ...
        try:
            ...
            self.port = 6697
        self.nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "hades-bot")
    ...
    async def _handle_line(self, raw: str) -> None:
        ...
        if command == "433":
            # Retry with incrementing suffix: hades_, hades_1, hades_2...
...
def check_requirements() -> bool:
    ...
    # hades setup / requirements check path.
...
async def _standalone_send(
    ...
    *,
    ...
    nickname = os.getenv("IRC_NICKNAME") or extra.get("nickname", "hades-bot")
    ...
    nick_base = nickname.rstrip("_0123456789-")[:24] or "hades-bot"
