...
AlexKucera reported on Discord (2026-04-16) that after ``hades update`` pulled
...
Opt-in — not part of default CI:
    HADES_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v
...
pytestmark = [
    pytest.mark.skipif(not LIVE, reason="live-only — set HADES_LIVE_TESTS=1"),
