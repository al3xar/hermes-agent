...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("HADES_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("HADES_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("HADES_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
