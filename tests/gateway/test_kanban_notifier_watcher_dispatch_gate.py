...
- HADES_KANBAN_DISPATCH_IN_GATEWAY env var disables without loading config.
...
def test_notifier_watcher_env_override_disables(monkeypatch):
    """HADES_KANBAN_DISPATCH_IN_GATEWAY=false skips config load entirely."""
    runner = _make_runner()
    monkeypatch.setenv("HADES_KANBAN_DISPATCH_IN_GATEWAY", "false")
