...
- Warning respects HADES_AGENT_TIMEOUT_WARNING env var
...
class TestStagedInactivityWarning:
    ...
    def test_warning_env_var_respected(self, monkeypatch):
        """HADES_AGENT_TIMEOUT_WARNING env var is parsed correctly."""
        monkeypatch.setenv("HADES_AGENT_TIMEOUT_WARNING", "600")
    ...
    def test_warning_zero_means_disabled(self, monkeypatch):
        """HADES_AGENT_TIMEOUT_WARNING=0 disables the warning."""
        monkeypatch.setenv("HADES_AGENT_TIMEOUT_WARNING", "0")
