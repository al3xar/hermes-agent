...
class TestTelegramYamlConfigLoading:
    ...
    def _write_config(self, tmp_path, content: str):
        ...
        hades_home.mkdir()
        (hades_home / "config.yaml").write_text(content, encoding="utf-8")
        return hades_home
    ...
    def test_top_level_reply_to_mode_off(self, tmp_path, monkeypatch):
        ...
        hades_home = self._write_config(tmp_path, "telegram:\n  reply_to_mode: off\n")
...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/NousResearch/hades-agent/issues/23994:
    reply_to_mode 'off' was ignored when sending via Hades-created DM topic
