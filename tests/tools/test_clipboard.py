...
Coverage:
  hades_cli/clipboard.py  — platform-specific image extraction (macOS, WSL, Wayland, X11)
...
class TestIsWsl:
    def setup_method(self):
        ...
        # globals so this stays stable even if hades_constants was imported
...
class TestPreprocessImagesWithVision:
    ...
    @pytest.fixture
    def cli(self):
        """Minimal HadesCLI with mocked internals."""
