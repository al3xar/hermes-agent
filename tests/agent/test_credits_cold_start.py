...
HADES_DEV_CREDITS_FIXTURE) so depletion AND the 90% grant warning fire immediately
...
def test_dev_fixtures_drive_cold_start():
    """Every HADES_DEV_CREDITS_FIXTURE state produces a valid seed CreditsState."""
    import os
    ...
    for name, want in expected.items():
        ...
        try:
            ...
            os.environ.pop("HADES_DEV_CREDITS_FIXTURE", None)
            os.environ.pop("HADES_DEV_CREDITS", None)
