...
def isolated_home(monkeypatch):
    ...
    test_home = tempfile.mkdtemp(prefix="hades_test_31179_")
    hades_home = os.path.join(test_home, ".hades")
    os.makedirs(hades_home)
...
def _fresh_modules():
    """Drop cached hades modules so each test reloads against current env."""
