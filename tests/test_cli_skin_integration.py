...
from cli import HadesCLI, _build_compact_banner, _rich_text_from_ansi
...
class TestCompactBannerSkinIntegration:
    def test_default_compact_banner_keeps_legacy_nous_hades_branding(self):
        set_active_skin("default")
        ...
        assert "NOUS HADES" in banner

    def test_poseidon_compact_banner_uses_skin_branding_instead_of_nous_hades(self):
        ...
        assert "NOUS HADES" not in banner
