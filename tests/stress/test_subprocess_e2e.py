    ...
    def _spawn(task, workspace):
        ...
        env = {
            **os.environ,
            ...
            "HOME": home,
            "PYTHONPATH": WT,
            "HADES_KANBAN_TASK": task.id,
            "HADES_KANBAN_WORKSPACE": workspace,
...
""")
    ...
    print("=" * 60)
    # Scenario A workers wrote to /tmp/hades_e2e_*/worker_*.log
    import glob
