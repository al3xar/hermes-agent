...
def worker_loop(worker_id: int, hades_home: str, result_file: str) -> None:
...
def reclaimer_loop(hades_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="hades_mixed_stress_")
