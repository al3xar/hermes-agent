...
def cli_instance(tmp_path, session_db):
    """Create a minimal HadesCLI-like object for testing _handle_branch_command."""
...
class TestBranchCommandCLI:
    ...
    def test_branch_creates_new_session(self, cli_instance, session_db):
        ...
        HadesCLI._handle_branch_command(cli_instance, "/branch")
    ...
    def test_branch_with_custom_name(self, cli_instance, session_db):
        ...
        HadesCLI._handle_branch_command(cli_instance, "/branch refactor approach")
    ...
    def test_branch_rotates_hades_session_id_env_and_context(self, cli_instance, session_db):
        ...
        _VAR_MAP["HADES_SESSION_ID"].set(old_session_id)
        ...
        try:
            ...
            assert get_session_env("HADES_SESSION_ID") == cli_instance.session_id
        finally:
