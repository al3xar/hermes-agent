"""Tests for `hades fallback` — chain reading, add/remove/clear, legacy migration."""
    ...
    def test_reads_new_list_format(self):
        ...
        cfg = {
            "fallback_providers": [
                ...
                {"provider": "nous", "model": "Hades-4-Llama-3.1-405B"},
            ]
        }
...
class TestListCommand:
    def test_list_empty(self, isolated_home, capsys):
        ...
        assert "hades fallback add" in out
...
class TestRemoveCommand:
    ...
    def test_remove_selected_entry(self, isolated_home, capsys):
        ...
        # Picker returns index 1 (the middle entry, "nous / Hades-4")
...
class TestArgparseWiring:
    """Verify `hades fallback` is wired into main.py's argparse tree.
