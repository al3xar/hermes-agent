...
class TestFallbackChain:
    ...
    PRIMARY = "https://hades-agent.nousresearch.com/docs/api/model-catalog.json"
    FALLBACK = (
        "https://raw.githubusercontent.com/NousResearch/hades-agent"
...
class TestIntegrationWithModelsModule:
    ...
    def test_picker_nous_row_uses_curated_list(self, tmp_path, monkeypatch):
        ...
        list in curated order — matching the ``hades model`` CLI — not the live
