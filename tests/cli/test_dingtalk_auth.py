"""Unit tests for hades_cli/dingtalk_auth.py (QR device-flow registration)."""
...
class TestApiPost:
    ...
    def test_raises_on_network_error(self):
        ...
        with patch("hades_cli.dingtalk_auth.requests.post",
            ...
            with pytest.raises(RegistrationError, match="Network error"):
                _api_post("/app/registration/init", {"source": "hades"})
    ...
    def test_returns_data_on_success(self):
        ...
        with patch("hades_cli.dingtalk_auth.requests.post", return_value=mock_resp):
            result = _api_post("/app/registration/init", {"source": "hades"})
