...
def kanban_home(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("HADES_MEDIA_ALLOW_DIRS", str(tmp_path))
    kb.init_db()
    return home
...
async def test_notifier_uploads_artifacts_on_completion(kanban_home, tmp_path, monkeypatch):
    ...
    # via ``HADES_MEDIA_ALLOW_DIRS``. Test fixtures live under ``tmp_path``,
    ...
    try:
        ...
        os.environ.pop("HADES_KANBAN_TASK", None)
