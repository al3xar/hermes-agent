...
Complements tests/cli/test_kanban_db.py (schema + CAS atomicity)
and tests/cli/test_kanban_cli.py (end-to-end run_slash).  The
...
def kanban_home(tmp_path, monkeypatch):
    ...
    # tests in tests/cli/test_kanban_db.py.
    monkeypatch.setenv("HADES_KANBAN_CRASH_GRACE_SECONDS", "0")
    kb.init_db()
    return home
