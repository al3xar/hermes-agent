"""Tests for hades_cli/goals.py — persistent cross-turn goals."""
...
class TestGoalManager:
    def test_no_goal_initial(self, hades_home):
    ...
    def test_set_then_status(self, hades_home):
        from hades_cli.goals import GoalManager
    ...
    def test_set_rejects_empty(self, hades_home):
        from hades_cli.goals import GoalManager
    ...
    def test_pause_and_resume(self, hades_home):
        from hades_cli.goals import GoalManager
    ...
    def test_clear(self, hades_home):
        from hades_cli.goals import GoalManager
    ...
    def test_persistence_across_managers(self, hades_home):
    ...
    def test_evaluate_after_turn_done(self, hades_home):
    ...
    def test_evaluate_after_turn_continue_under_budget(self, hades_home):
        from hades_cli import goals
        from hades_cli.goals import GoalManager
    ...
    def test_evaluate_after_turn_budget_exhausted(self, hades_home):
    ...
    def test_evaluate_after_turn_inactive(self, hades_home):
    ...
    def test_continuation_prompt_shape(self, hades_home):
        ...
        mgr.set("port goal command to hades")
        prompt = mgr.next_continuation_prompt()
        assert prompt is not None
        assert "port goal command to hades" in prompt
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, hades_home):
    ...
    def test_parse_failure_counter_resets_on_good_reply(self, hades_home):
    ...
    def test_parse_failure_counter_not_incremented_by_api_errors(self, hades_home):
...
class TestGoalManagerSubgoals:
    def test_add_subgoal(self, hades_home):
        from hades_cli.goals import GoalManager
    ...
    def test_add_subgoal_requires_active_goal(self, hades_home):
        import pytest
        from hades_cli.goals import GoalManager
    ...
    def test_add_empty_subgoal_rejected(self, hades_home):
        import pytest
        from hades_cli.goals import GoalManager
    ...
    def test_remove_subgoal(self, hades_home):
        from hades_cli.goals import GoalManager
    ...
    def test_remove_subgoal_out_of_range(self, hades_home):
        import pytest
        from hades_cli.goals import GoalManager
    ...
    def test_clear_subgoals(self, hades_home):
        from hades_cli.goals import GoalManager
    ...
    def test_subgoals_persist_across_reloads(self, hades_home):
...
class TestContinuationPromptWithSubgoals:
    def test_empty_subgoals_uses_original_template(self, hades_home):
        from hades_cli.goals import GoalManager
    ...
    def test_with_subgoals_includes_them(self, hades_home):
        from hades_cli.goals import GoalManager
...
class TestJudgeGoalWithSubgoals:
    def test_judge_uses_subgoals_template_when_provided(self, hades_home):
    ...
    def test_judge_uses_original_template_when_no_subgoals(self, hades_home):
        from unittest.mock import patch
        from hades_cli import goals
...
class TestStatusLineSubgoalCount:
    def test_status_line_no_subgoals(self, hades_home):
        from hades_cli.goals import GoalManager
    ...
    def test_status_line_with_subgoals(self, hades_home):
        from hades_cli.goals import GoalManager
