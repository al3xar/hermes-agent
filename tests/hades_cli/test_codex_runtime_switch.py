...
class TestApply:
    ...
    def test_enable_succeeds_when_codex_present(self):
        ...
        assert "via MCP" in r.message  # hades-tools callback message
        assert cfg["model"]["openai_runtime"] == "codex_app_server"
    ...
    def test_enable_triggers_mcp_migration(self):
        """Enabling codex_app_server should auto-migrate Hades mcp_servers
        ...
        with patch.object(crs, "check_codex_binary_ok",
            ...
            mig.return_value.migrated = ["filesystem", "hades-tools"]
        ...
        # User MCP servers are reported (excluding internal hades-tools)
        ...
        # Hades tool callback announcement
