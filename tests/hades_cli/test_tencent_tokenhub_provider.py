...
# =============================================================================
# CANONICAL_PROVIDERS (hades model picker)
# =============================================================================
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in HADES_OVERLAYS
        overlay = HADES_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubDoctor:
    """Verify hades doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from hades_cli.providers import HADES_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = HADES_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``hades model`` routes it through the generic api_key_provider flow.
        """
        import inspect
