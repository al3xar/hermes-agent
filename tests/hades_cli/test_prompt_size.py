"""Tests for the ``hades prompt-size`` diagnostic (issue #34667)."""
...
def _seed_memory(hades_home, memory_text="", user_text=""):
    mem_dir = hades_home / "memories"
...
def _seed_skill(hades_home, name, description):
    skill_dir = hades_home / "skills" / "demo" / name
