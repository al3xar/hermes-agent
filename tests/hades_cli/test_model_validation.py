...
class TestParseModelInput:
    ...
    def test_nous_provider_switch(self):
        provider, model = parse_model_input("nous:hades-3", "openrouter")
        assert provider == "nous"
        assert model == "hades-3"
...
class TestFetchApiModels:
    ...
    def test_returns_none_on_network_error(self):
        with patch("hades_cli.models.urllib.request.urlopen", side_effect=Exception("timeout")):
    ...
    def test_probe_api_models_tries_v1_fallback(self):
        ...
        with patch("hades_cli.models.urllib.request.urlopen", side_effect=_fake_urlopen):
    ...
    def test_probe_api_models_uses_copilot_catalog(self):
        ...
        with patch("hades_cli.models.urllib.request.urlopen", return_value=_Resp()) as mock_urlopen:
    ...
    def test_fetch_github_model_catalog_filters_non_chat_models(self):
        ...
        with patch("hades_cli.models.urllib.request.urlopen", return_value=_Resp()):
...
class TestValidateApiFallback:
    ...
    def test_fetch_lmstudio_models_filters_embedding_type(self):
        ...
        with patch("hades_cli.models.urllib.request.urlopen", return_value=mock_resp):
    ...
    def test_fetch_lmstudio_models_raises_auth_error_on_401(self):
        ...
        with patch("hades_cli.models.urllib.request.urlopen", side_effect=http_error):
    ...
    def test_fetch_lmstudio_models_returns_empty_on_network_error(self):
        with patch(
            "hades_cli.models.urllib.request.urlopen",
...
class TestProbeApiModelsUserAgent:
    """Probing custom /v1/models must send a Hades User-Agent.
    ...
    def test_probe_sends_hades_user_agent(self):
        ...
        assert ua.startswith("hades-cli/"), (
            f"User-Agent must advertise hades-cli, got {ua!r}"
        )
    ...
    def test_probe_user_agent_sent_without_api_key(self):
        ...
        assert ua and ua.startswith("hades-cli/")
