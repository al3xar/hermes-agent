...
``tests/hades_cli/test_plugin_scanner_recursion.py::TestRegisterImageGenProvider``.
"""
...
class TestRegisterTTSProvider:
    ...
    def test_accepts_valid_provider(self):
        ...
        hades_home = Path(os.environ["HADES_HOME"])
        _write_plugin(
            hades_home / "plugins",
            "my-tts-plugin",
            register_body=(
        ...
        _enable(hades_home, "my-tts-plugin")
    ...
    def test_rejects_non_provider(self, caplog):
        ...
        _enable(hades_home, "bad-tts-plugin")
    ...
    def test_rejects_builtin_shadow(self, caplog):
        ...
        _enable(hades_home, "shadow-tts-plugin")
