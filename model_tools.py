...
#   - cli.py, hades_cli/*      -> inline on startup (no event loop)
...
def _compute_tool_definitions(
    ...
    if enabled_toolsets is not None:
        ...
        if os.environ.get("HADES_KANBAN_TASK") and "kanban" not in effective_enabled_toolsets:
            # Dispatcher-spawned workers are scoped by HADES_KANBAN_TASK and
    ...
    # This ensures that even if a composite toolset (like hades-cli)
    ...
    # window). Core Hades tools (toolsets._HADES_CORE_TOOLS) are NEVER
