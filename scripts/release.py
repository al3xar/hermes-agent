...
VERSION_FILE = REPO_ROOT / "hades_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "274096618+hades-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "hades@nousresearch.com": "NousResearch",
    ...
    "hades@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "github@nadyahades.anonaddy.com": "ruangraung",  # PR #42308
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (HADES_KANBAN_BOARD restore)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: hades-eval community link)
    ...
    "hadesagent26@gmail.com": "hadesagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+hadesagent26@users.noreply.github.com": "hadesagent26",
    ...
    "vigo@hades": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Hades runtime files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Hades
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "hades@nousresearch.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/NousResearch/hades-agent",
