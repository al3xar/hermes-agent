...
DEFAULT_DATASETS = [
    ...
    "NousResearch/hades-agent-megascience-sft1",
    "NousResearch/Hades-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Hades-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-hades-agent"
]
