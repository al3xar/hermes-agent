...
A runner that uses Hades-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Hades-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Hades-Agent's Docker, Modal, or Local environments for command execution
...
# ============================================================================
# Terminal Tool Definition (matches Hades-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Hades-Agent's built-in backends.
...
class MiniSWERunner:
    """
    Agent runner that uses Hades-Agent's built-in execution environments
...
Complete the user's task step by step."""
        ...
        trajectory = self._convert_to_hades_format(messages, task, completed)
