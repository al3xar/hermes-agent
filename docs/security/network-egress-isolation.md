...
#
# Usage:
#   HADES_UID=$(id -u) HADES_GID=$(id -g) docker compose up -d
#
...
services:
  gateway:
    ...
    environment:
      ...
      - NO_PROXY=hades,hades-dashboard,localhost
...
docker compose exec gateway \
  curl -sf --max-time 5 http://hades-dashboard:9119/health && echo "OK: internal reachable" || echo "FAIL"
