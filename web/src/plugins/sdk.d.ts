/**
 * Hades Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__HADES_PLUGIN_SDK__`` and
 * ``window.__HADES_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__HADES_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``HadesPluginSDK["sdkVersion"]`` (and the
 ...
 * of calling ``fetch`` with a hand-read ``window.__HADES_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__HADES_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__HADES_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface HadesPluginSDK {
...
declare global {
  interface Window {
    __HADES_PLUGIN_SDK__?: HadesPluginSDK;
    __HADES_PLUGINS__?: PluginRegistry;
  }
}
