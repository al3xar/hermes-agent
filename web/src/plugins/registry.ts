 ...
 *
 * Plugins call window.__HADES_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__HADES_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  ...
  window.__HADES_PLUGIN_SDK__ = {
    ...
    // window.__HADES_SESSION_TOKEN__ directly.
    authedFetch,
