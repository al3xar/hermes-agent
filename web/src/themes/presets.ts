 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `hades_cli/web_server.py`.
 */
...
/**
 * Nous Blue — the inverted "light mode" Hades look, ported from the
 ...
 * nousnet-web's <body> is white; hades-agent's App root is `bg-black`,
