...
const STORAGE_KEY = "hades-dashboard-theme";
...
const FONT_STORAGE_KEY = "hades-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `hades_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "hades-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-hades-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-hades-theme-font", "true");
