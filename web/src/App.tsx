...
const SIDEBAR_COLLAPSED_KEY = "hades-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="hades-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="hades-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateHades,
      runningLabel: t.status.updatingHades,
      spin: false,
    },
  ];
