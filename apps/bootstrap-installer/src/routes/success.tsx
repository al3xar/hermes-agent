...
import { launchHadesDesktop } from '../store'
 ...
 * Hades.exe doesn't exist). We catch the Tauri error and surface it
 * inline rather than silently doing nothing — the previous version
 * had `onClick={() => void launchHadesDesktop()}` which swallowed
...
export default function Success() {
  ...
  return (
    <div className="hades-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
