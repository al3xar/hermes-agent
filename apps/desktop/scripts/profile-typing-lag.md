...
cd apps/desktop
XCURSOR_SIZE=24 HADES_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/hades-typing
# → /tmp/hades-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/hades-typing.before.heapsnapshot
# → /tmp/hades-typing.after.heapsnapshot
```
