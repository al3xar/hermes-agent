 ...
 * product name (`Hades`). If a PREVIOUS `npm run pack` was interrupted
 ...
 *
 * This is a hard failure with no obvious cause for the user — `hades desktop`
 ...
 * (the mac-unpacked Hades.app bundle) and Windows (win-unpacked), so we
