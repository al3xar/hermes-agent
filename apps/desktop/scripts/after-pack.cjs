 ...
 * — first install, `hades desktop`, the installer's --update rebuild, and a
...
exports.default = async function afterPack(context) {
  ...
  try {
    ...
    console.warn(`[after-pack] exe identity stamp failed (${err.message}); Hades.exe keeps the stock Electron icon`)
  }
}
