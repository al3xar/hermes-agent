...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/hades'
 ...
 * log inline — the GUI equivalent of the install step `hades tools` runs
