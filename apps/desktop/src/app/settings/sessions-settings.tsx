...
import { deleteSession, listSessions, setSessionArchived } from '@/hades'
...
// / Program Files), which buried any files Hades wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.hadesDesktop` is
    ...
    const settings = window.hadesDesktop?.settings
  ...
  return (
    <div className="mb-6">
      ...
      <ListRow
        ...
        description={dir || s.defaultsTo(fallback || '~/hades-projects')}
