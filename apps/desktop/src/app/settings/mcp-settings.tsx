...
import { getHadesConfigRecord, type HadesGateway, saveHadesConfig } from '@/hades'
import { useI18n } from '@/i18n'
import { Wrench } from '@/lib/icons'
import { cn } from '@/lib/utils'
import { notify, notifyError } from '@/store/notifications'
import { $activeSessionId } from '@/store/session'
import type { HadesConfigRecord } from '@/types/hades'
...
function getServers(config: HadesConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveHadesConfig(nextConfig)
