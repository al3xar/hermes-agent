import type { HadesConfigRecord, ToolsetInfo } from '@/types/hades'
...
export function getNested(obj: HadesConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: HadesConfigRecord, path: string, value: unknown): HadesConfigRecord {
...
function personalityOptions(config: HadesConfigRecord): string[] {
