...
const desktopWindow = window as unknown as { hadesDesktop?: Window['hadesDesktop'] }
const initialHadesDesktop = desktopWindow.hadesDesktop

function installDesktopBridge(partial: Partial<Window['hadesDesktop']> = {}) {
  desktopWindow.hadesDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['hadesDesktop']
}
...
afterEach(() => {
  ...
  if (initialHadesDesktop) {
    desktopWindow.hadesDesktop = initialHadesDesktop
  } else {
    delete desktopWindow.hadesDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['hadesDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['hadesDesktop']['openExternal'] })
