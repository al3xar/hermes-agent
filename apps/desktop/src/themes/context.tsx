...
const SKIN_KEY = 'hades-desktop-theme-v2'
const MODE_KEY = 'hades-desktop-mode-v1'
...
const PROFILE_SKINS_KEY = 'hades-desktop-profile-themes-v1'
const PROFILE_MODES_KEY = 'hades-desktop-profile-modes-v1'
// Last active profile, recorded so the boot-time paint can pick that profile's
// theme before the gateway reports which profile actually launched.
const LAST_PROFILE_KEY = 'hades-desktop-active-profile-v1'
...
function applyTheme(theme: DesktopTheme, mode: 'light' | 'dark') {
  ...
  root.dataset.hadesTheme = skinName
  root.dataset.hadesMode = rendered
  ...
  window.hadesDesktop?.setTitleBarTheme?.({
  ...
  if (typo.fontUrl && !INJECTED_FONT_URLS.has(typo.fontUrl)) {
    ...
    link.dataset.hadesThemeFont = 'true'
