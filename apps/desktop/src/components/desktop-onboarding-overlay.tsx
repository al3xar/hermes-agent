...
import type { ModelOptionProvider, OAuthProvider } from '@/types/hades'
...
// onboarding / Providers key form lists every `api_key` provider `hades model`
...
const SHOW_ALL_KEY = 'hades-onboarding-show-all-v1'
