...
import type { ModelOptionProvider, ModelOptionsResponse, ModelPricing } from '@/types/hades'

import type { HadesGateway } from '../hades'
import { getGlobalModelOptions } from '../hades'
...
export function ModelPickerDialog({
  ...
  // the `hades model` CLI picker, which shows the curated list verbatim.
