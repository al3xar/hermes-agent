...
const SIDEBAR_PINNED_STORAGE_KEY = 'hades.desktop.pinnedSessions'
const SIDEBAR_AGENTS_GROUPED_STORAGE_KEY = 'hades.desktop.agentsGroupedByWorkspace'
const SIDEBAR_CRON_OPEN_STORAGE_KEY = 'hades.desktop.sidebarCronOpen'
const SIDEBAR_MESSAGING_OPEN_STORAGE_KEY = 'hades.desktop.sidebarMessagingOpen'
const SIDEBAR_SESSION_ORDER_STORAGE_KEY = 'hades.desktop.sessionOrder'
const SIDEBAR_WORKSPACE_ORDER_STORAGE_KEY = 'hades.desktop.workspaceOrder'
const PANES_FLIPPED_STORAGE_KEY = 'hades.desktop.panesFlipped'
...
export const SESSION_SEARCH_FOCUS_EVENT = 'hades:focus-session-search'
