...
export const zh: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHadesDesktop: '正在启动 Hades 桌面版…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc: '取消设置 HADES_DESKTOP_REMOTE_URL 和 HADES_DESKTOP_REMOTE_TOKEN 后才会使用下面保存的设置。',
      localTitle: '本地网关',
      ...
      remoteUrlDesc: '远程 dashboard 后端的基础 URL。支持路径前缀，例如 /hades。',
  ...
  commandCenter: {
    ...
    hadesActiveSessions: (version, count) => `Hades ${version} · 活跃会话 ${count}`,
  ...
  messaging: {
    ...
    platformIntro: {
      ...
      bluebubbles: '在装有 iMessage 的 Mac 上运行 BlueBubbles Server，暴露其 API，然后用服务器密码把 Hades 指向该 URL。',
      ...
      weixin: '登录微信公众平台，复制 AppID 和 Token，并把消息回调 URL 指向 Hades。',
  ...
  updates: {
    ...
    applyingBody: 'Hades 更新器会在自己的窗口中接管，并在完成后重新打开 Hades。',
    applyingBodyBackend: '远程后端正在应用更新并将重启。恢复后 Hades 会自动重新连接。',
    applyingClose: 'Hades 将关闭以应用更新。',
    errorTitle: '更新未完成',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `这会将“${pattern}”模式加入永久允许列表 (~/.hades/config.yaml)。Hades 对类似命令将不再询问，包括当前会话和未来会话。`,
      alwaysAllow: '始终允许'
    },
    clarify: {
      notReady: '澄清请求尚未就绪',
