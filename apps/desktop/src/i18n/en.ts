...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      startingHadesDesktop: 'Starting Hades Desktop…'
    },
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc:
        'Unset HADES_DESKTOP_REMOTE_URL and HADES_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /hades.',
  ...
  commandCenter: {
    ...
    hadesActiveSessions: (version, count) => `Hades ${version} · Active sessions ${count}`,
  ...
  updates: {
    ...
    applyingBody: 'The Hades updater will take over in its own window and reopen Hades when it’s done.',
    applyingBodyBackend: 'The remote backend is applying the update and will restart. Hades reconnects automatically when it’s back.',
    applyingClose: 'Hades will close to apply the update.',
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hades/config.yaml). Hades won’t ask again for commands like this — in this session or any future one.`,
