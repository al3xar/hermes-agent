"""
Hades MCP Server — expose messaging conversations as MCP tools.
...
Plus: channels_list (Hades-specific extra)

Usage:
    hades mcp serve
    hades mcp serve --verbose
...
logger = logging.getLogger("hades.mcp_serve")
